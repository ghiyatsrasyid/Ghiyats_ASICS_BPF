          ...
          <div class="card mb-4">
            ...
            <div class="card-body content-center" style="padding-left: 200px; padding-right: 200px;">
                ...
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="NEW/SECOND" value="<?= set_value('status'); ?>" name="status" id="status">
                        <?= form_error('status', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Stok" value="<?= set_value('stok'); ?>" name="stok" id="stok">
                        <?= form_error('stok', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Harga" value="<?= set_value('harga'); ?>" name="harga" id="harga">
                        <?= form_error('harga', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Kategori" value="<?= set_value('kategori'); ?>" name="kategori" id="kategori">
